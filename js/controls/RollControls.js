...
THREE.RollControls = function ( object, domElement ) {
	...
	function onKeyDown( event ) {
		...
		switch ( event.keyCode ) {
			...
			case 107: /*+*/ forwardSpeed = 1; break;
			case 109: /*-*/ forwardSpeed = -1; break;
	...
	function onKeyUp( event ) {
		...
		switch( event.keyCode ) {
			...
			case 70: /*F*/ upSpeed = 0; break;
			    ...
			    case 107: /*+*/ forwardSpeed = 0; break;
			case 109: /*-*/ forwardSpeed = 0; break;
...
/*	function onMouseMove( event ) {
	...
	document.getElementById('btn1').addEventListener('mousedown',zoomin, false);
		document.getElementById('btn2').addEventListener('mousedown',zoomout, false);
